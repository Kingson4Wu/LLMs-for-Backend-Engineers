...
Transformer 是 2017 年《Attention is All You Need》论文提出的架构，已成为现代大型语言模型的基础。本节从工程视角解析其核心组件和数据流。
...
- **FFN**：节点的本地计算逻辑（详见 [数学基础：激活函数](../part1-math-foundations/activation-functions)）
- **LayerNorm**：层内归一化，稳定训练梯度（详见 [数学基础：LayerNorm](../part1-math-foundations/layer-norm)）
- **多层**：多轮全局通信 + 本地计算
