...
- [梯度消失与梯度爆炸](./vanishing-exploding-gradients) — 当追责链条（网络层数）太长时，梯度连乘会出现什么问题，以及残差连接如何给追责提供一条"直达通道"
- [LayerNorm](./layer-norm) — 归一化如何让梯度在反向传播中更稳定，不至于追责到一半数值就崩溃
- [交叉熵](./cross-entropy) — 交叉熵 + Softmax 的梯度恰好是 p_i - y_i，是反向传播中少有的"简洁追责"
