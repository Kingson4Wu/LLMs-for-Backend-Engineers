...
- [从 One-hot 到 Embedding：词的分布式表示](./from-onehot-to-embedding) — Embedding 如何用向量表示词的语义
- [Attention 机制](../part2-llm-internal/attention-mechanism) — 点积在 Attention 中用于计算 Query 与 Key 的相似度
