...
- [向量与嵌入基础：向量点积与夹角关系](../part1-math-foundations/dot-product-angle) — 理解向量相似度的数学基础
- [Embedding：从 One-hot 到分布式表示](../part2-llm-internal/embedding-evolution) — Embedding 训练原理，以及为什么语义信息可以被压缩进向量
