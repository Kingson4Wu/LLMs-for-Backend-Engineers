---
sidebar_label: '优化器选择：从 SGD 到 AdamW'
sidebar_position: 5
---
...
- [反向传播：梯度是如何计算的](../math_foundations/backpropagation) —— 理解梯度的来源
- [梯度消失与梯度爆炸：训练深层的核心障碍](../math_foundations/vanishing-exploding-gradients) —— 理解为什么优化器选择直接影响深层网络的训练可行性
