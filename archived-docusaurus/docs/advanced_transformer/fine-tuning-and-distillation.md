...
直觉上的矛盾来自把三件事混为一谈：**学到的东西多不多、拟合好不好、参数多不多。**这三者并不等价。
...
- [数学基础：反向传播](../math_foundations/backpropagation) — 微调和蒸馏的训练信号都依赖反向传播
- [数学基础：交叉熵损失](../math_foundations/cross-entropy) — 蒸馏的 KL 散度是最小化交叉熵的变体
- [Transformer 架构](../advanced_transformer/transformer_architecture) — 微调通常在 Transformer 架构上进行
