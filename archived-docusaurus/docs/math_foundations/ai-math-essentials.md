...
- [Transformer 架构总览](../advanced_transformer/transformer_architecture.md) — 所有这些数学机制最终如何组装成 Transformer
- [Attention 机制](../advanced_transformer/attention_mechanism.md) — Softmax 在 Attention 中的核心角色
